...
<meta name="keywords" content="Estrutura, Asilo, Casa de repouso, Idosas, Associação filantrópica"/>
  ...
  <title>Asilo São Vicente | Quem somos - Bazar</title>
...
<div id="preloading" class="loader"></div>
  ...
  <section id="content" role="main">
    ...
    <div id="main" role="main" role="application">
...
<article id="content_pages" class="galeria" role="article">
		...
		<header role="banner"><h1>Nosso Bazar</h1></header>
            
                <article id="scrollText" role="article">
			<p><strong>Possuímos um bazar com diversas peças de roupas e objetos para<br />
                        venda com objetivo de reverter em lucros para o asilo.
                        <br />Venha conhecer!!!</strong><br />
			</p>
                              <div class="banner_bazar behavior">
                              <img src="img/ajudar-o-bem-faz-bem.png" alt="Ajudar o próximo faz vem" >
                                <p>AJUDAR O PROXIMO <br />
         ...
         <img src="img/shadow.png" style="" class="shadow_Footer" alt="Detalge de Sombra" />        
 </article>
